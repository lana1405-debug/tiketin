        ...
        {boostedEvents.length > 0 && (
          ...
          >
            ...
            >
              ...
              {/* LEFT: content */}
              <div className="relative z-10 flex flex-col justify-end p-5 sm:p-6 md:p-8 w-full md:w-[52%] shrink-0 h-full">
              ...
              {/* RIGHT: full poster image, not cropped, hidden on mobile */}
              <div className="relative flex-1 h-full bg-zinc-900 border-l-4 border-[var(--primary-color)]/25 overflow-hidden hidden md:block">
                <AnimatePresence mode="wait">
                  <motion.img
                    key={currentBoostedIdx}
                    src={boostedEvents[currentBoostedIdx]?.image_url}
